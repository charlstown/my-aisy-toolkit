...
- [x] @code-developer · Sustituir el badge de versión en README-ES.md: mismo cambio que la tarea anterior en `D:\00_WIP\2608_MyAIsyToolkit\my-aisy-toolkit\README-ES.md`, línea 14, con la **misma URL exacta** pero conservando el atributo original `alt="Versión"` (con tilde). No tocar nada más del fichero. Cubre FR-006 y SC-003.
