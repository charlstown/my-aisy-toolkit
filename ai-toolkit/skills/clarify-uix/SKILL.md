...
If any feature still has items left open ("not sure yet"), remind the user they can run `/aisy.clarify-uix` again on that feature once they have an answer.
