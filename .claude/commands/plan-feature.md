...
| Ambiguous scope that could double the size of the feature | "Does the fix apply only to the entry-sheet or also to TipoCobroEditor?" | Unspecified style details (the planner reads css-spec) |
